...
//	unsigned long i;
    ...
    TFTSPI_P8X16Str(0, 0, "Test ADC",u16WHITE,u16BLACK);      //字符串显示
//    OLED_Init();
...
//    	OLED_P6x8Str(0,3,txt);                      //显示采样时间
        ...
        sprintf(txt, "ADC0: %d", v);            //转换为字符串
        TFTSPI_P8X16Str(0,1,txt,u16WHITE,u16BLACK); //字符串显示
        v=ADC_Read(ADC1);
        sprintf(txt, "ADC1: %d", v);            //转换为字符串
        TFTSPI_P8X16Str(0,3,txt,u16RED,u16BLACK); //字符串显示
        v=ADC_Read(ADC2);
        sprintf(txt, "ADC2: %d", v);            //转换为字符串
        TFTSPI_P8X16Str(0,5,txt,u16GREEN,u16BLACK); //字符串显示
        v=ADC_Read(ADC3);
        sprintf(txt, "ADC3: %d", v);            //转换为字符串
        TFTSPI_P8X16Str(0,7,txt,u16PURPLE,u16BLACK); //字符串显示
        delayms(50);              //延时等待
    }
