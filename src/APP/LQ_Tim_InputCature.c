...
void LQ_TIM_InputCature(void)
{
    ...
    TIM_InitConfig(IfxGtm_TIM2_3_TIN71_P15_0_IN);//P15_0 作为脉冲捕获管脚
    TOM_PWM_InitConfig(IfxGtm_TOM1_13_TOUT65_P20_9_OUT, 5000, 125);//初始化P20_9 作为PWM输出口 频率125Hz 占空比 百分之(5000/TOM_PWM_MAX)*100
    while(1)
    {
