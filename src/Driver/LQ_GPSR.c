...
const void *CpuSoftIrqFuncPointer[12] = {
        &CPU0_SOFT_IRQ0Handler, &CPU0_SOFT_IRQ1Handler, &CPU0_SOFT_IRQ2Handler,	&CPU0_SOFT_IRQ3Handler,
        &CPU1_SOFT_IRQ0Handler, &CPU1_SOFT_IRQ1Handler,	&CPU1_SOFT_IRQ2Handler, &CPU1_SOFT_IRQ3Handler,
        &CPU2_SOFT_IRQ0Handler, &CPU2_SOFT_IRQ1Handler, &CPU2_SOFT_IRQ2Handler, &CPU2_SOFT_IRQ3Handler,
};
